...
export const staggerContainer = {
  animate: {
    transition: {
      ...
      delayChildren: 0 // Remove base delay for immediate user message display
    }
  }
};

export const staggerItem = {
  initial: { opacity: 0, y: 10 }, // Reduced initial offset for subtler animation
  animate: { opacity: 1, y: 0 },
  transition: { duration: 0.25, ease: [0.4, 0, 0.2, 1] } // Faster animation for immediate feedback
};
