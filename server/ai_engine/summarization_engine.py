    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        if openai_available:
            ...
            if api_key and endpoint:
                ...
                logger.info("SafetySummarizationEngine: Azure OpenAI client initialized with high-performance settings")
            else:
                logger.warning("SafetySummarizationEngine: Azure OpenAI API key or endpoint not found")
        else:
            logger.warning("SafetySummarizationEngine: Azure OpenAI not available")
