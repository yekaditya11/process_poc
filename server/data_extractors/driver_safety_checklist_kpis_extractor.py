...
class DriverSafetyChecklistKPIsExtractor:
    ...
    def get_driver_safety_checklist_kpis(self, customer_id: Optional[str] = None,
        ...
        try:
            ...
            # Hardcode to 76% for 6 months and 1 year filters to prevent unrealistic percentages
            if days_back in [180, 365]:  # 6 months or 1 year
                daily_completion_percentage = 76.0
            else:
